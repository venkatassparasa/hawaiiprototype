...
const PublicOverview = () => {
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <div className="bg-[url('/p_dashboard.png')] bg-cover bg-center rounded-3xl p-8 text-white shadow-xl relative overflow-hidden">
                <div className="relative z-10 max-w-2xl">
                    ...
                    <div className="flex flex-wrap gap-4">
                        ...
                        <Link
                            to="/submit-complaint"
                            className="bg-white backdrop-blur-md text-black px-6 py-3 rounded-xl font-bold hover:bg-white/30 transition-colors flex items-center gap-2 border border-white/30"
                        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
                    <div className="w-full h-32 bg-white-50 rounded-xl flex items-center justify-center text-purple-600 mb-4">
                        ...
                        <img src="/r_public.png" alt="Resources Icon" className="w-64 h-32" />
                     </div>
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
                    <div className="w-full h-32 bg-white-50 rounded-xl flex items-center justify-center text-green-600 mb-4">
                        {/* <Info className="w-6 h-6" /> */}
                        <img src="/registration.png" alt="Status Icon" className="w-64 h-32" />
                    </div>
